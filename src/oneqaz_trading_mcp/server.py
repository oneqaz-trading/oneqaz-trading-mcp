    ...
    try:
        server = FastMCP(
            ...
            instructions=(
                ...
                "All signals and analysis are generated by automated systems and may contain errors. "
                "Users are solely responsible for their own investment decisions. "
                "Always recommend users do their own research (DYOR) before acting on any data."
            ),
        )
    except TypeError:
